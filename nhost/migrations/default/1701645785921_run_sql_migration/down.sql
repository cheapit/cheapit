...
--
--
-- CREATE TABLE public.chain_data_instructions (
--     id SERIAL PRIMARY KEY,
--     chain_id INTEGER NOT NULL,
--     name VARCHAR(255) NOT NULL,
--     link TEXT NOT NULL,
--     open_date_folder BOOLEAN,
--     login BOOLEAN NOT NULL,
--     username VARCHAR(255),
--     password VARCHAR(255),
--     username_selector VARCHAR(255),
--     password_selector VARCHAR(255),
--     login_btn_selector VARCHAR(255),
--     files_table_selector VARCHAR(255) NOT NULL,
--     extra_selector VARCHAR(255),
--     target_type VARCHAR(50) CHECK (target_type IN ('button', 'a')) NOT NULL,
--     date_attribute VARCHAR(255) NOT NULL,
--     file_name_in_diff_element VARCHAR(255),
--     network_code INTEGER NOT NULL,
--     pagination_selector VARCHAR(255),
--     today_selector VARCHAR(255),
--     filter_obj JSONB
-- );
